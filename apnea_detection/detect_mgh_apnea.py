...
df_resp_label_to_keep.to_csv('all_resp_labels_good.zip', index=False, compression='zip')
raise SystemExit
...
for i in tqdm(range(16,20)):#len(sid_dov_to_remove))):
    #try:
    ...
    if signal_path is None or annot_path is None:
        continue
    ...
    df_res_.to_csv('resp_labels_WaveNet0-20.csv', index=False)
